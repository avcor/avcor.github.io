...
/** Renders `` `code` `` spans inline as styled <code> — a markdown-style
 *  trial for calling out identifiers/commands within prose paragraphs. */
...
interface DeepDivePanelProps {
  ...
  /** Overrides the proof column — used to drop the pipeline map into a panel. */
  proofSlot?: ReactNode
  proofLabel?: string
}
