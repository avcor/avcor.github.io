...
export const DEEP_DIVE_PANELS: DeepDivePanel[] = [
  {
    ...
    accentIndex: 1,
    impact: '60 native modules · 0 rewrites',
    problem:
  ...
  },
  {
    ...
    accentIndex: 1,
    impact: '0 double-navigations · 4 re-entry paths',
    problem:
  ...
  },
  {
    ...
    decision:
      'Re-warm the engine before super.onCreate, so the delegate finds a live engine where it expects one. On re-warm we drop savedInstanceState — it belongs to the dead engine.',
    insight:
...
super.onCreate(if (engineWasCached) savedInstanceState else null)`,
  ...
  },
  {
    ...
    proof: {
      kind: 'code',
      filename: 'MethodChannel · com.CollPoll',
