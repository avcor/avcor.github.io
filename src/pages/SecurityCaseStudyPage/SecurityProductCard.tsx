...
import noticeShot from '../../assets/screenshots/security-notice.png'
import installShot from '../../assets/screenshots/security-install-not-verified.png'
import playStoreShot from '../../assets/screenshots/security-playstore-blocked.png'
import ScreenshotLightbox from '../FlutterCaseStudyPage/ScreenshotLightbox'
import styles from './SecurityProductCard.module.css'

const screenshots = [
  { src: noticeShot, alt: 'Security Notice dialog: the installation could not be verified and may have been modified, reinstall from the official Play Store' },
  { src: installShot, alt: 'Login screen blocked by a "This app installation could not be verified" dialog' },
  { src: playStoreShot, alt: 'Play Store search: "Looking for Digiicampus? This app won\'t work for your device"' },
]
